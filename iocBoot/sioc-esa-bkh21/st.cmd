...
# BK9000 + KL2531 + KL2541 + KL3172 + KL4001 + KL2114 + KL9010
...
drvAsynIPPortConfigure( "BKH$(N)","sioc-esa-bkh21:502",0,0,1)
...
drvBkhAsynConfig(2,    "A3172", 3,     6,  4, 2, 200)
drvBkhAsynConfig(1,    "A3314", 3,    10,  8, 4, 200)
drvBkhAsynConfig(2,    "A4001", 3,    18,  4, 2,   0)

#asynSetTraceIOMask( "A3172",0,4)
#asynSetTraceMask( "A3172",0,0xf)
