...
drvAsynIPPortConfigure( "BKH$(N)","172.27.249.11:502",0,0,1)
...
drvBkhAsynConfig(1, "A3222", 3,     0, 12, 6, 200)
drvBkhAsynConfig(1, "A3162", 3,    12,  4, 2, 200)
drvBkhAsynConfig(1, "A3314", 3,    16, 40,20, 200)

#asynSetTraceIOMask( "A3222",0,4)
#asynSetTraceMask( "A3222",0,0x9)

dbLoadRecords( "db/bkh$(N).db","P=$(LOC),M=$(N),LOC=$(LOC),IOC=$(IOC)")
