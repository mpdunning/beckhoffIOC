...
# BK9000 + 2xKL2114 + KL9190 + 2xKL2124 + KL1124 + KL3064 + 2xKL3314 + KL9010
...
epicsEnvSet("N",  "8")
epicsEnvSet("P",  "ESB")
epicsEnvSet("LOC","NLCTA Laser Room")
...
drvBkhAsynConfig(4, "A2114", 5,     0,  8, 0,1000)
drvBkhAsynConfig(4, "A2124", 5,     8,  8, 8,1000)
drvBkhAsynConfig(3, "A1124", 2,     0,  4, 4, 100)
drvBkhAsynConfig(2, "A3162", 3,     0,  4, 2, 200)
drvBkhAsynConfig(2, "A3064", 3,     4,  8, 4, 100)
drvBkhAsynConfig(1, "A3314", 3,    12, 16, 8, 100)

#asynSetTraceIOMask( "A3064",0,4)
#asynSetTraceMask( "A3064",0,0xf)

dbLoadRecords( "db/bkh0$(N).db","P=$(P),M=$(N),IOC=$(IOC),LOC=$(LOC)")
dbLoadRecords( "db/bkh0$(N)Alias.db","P=$(P),M=$(N)")
