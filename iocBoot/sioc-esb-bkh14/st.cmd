...
epicsEnvSet("N",  "14")
epicsEnvSet("P",  "ESB")
epicsEnvSet("LOC","NLCTA Girder 15")
...
drvBkhAsynConfig(0, "B900R", 3,0x1000, 33,33,1000)
drvBkhAsynConfig(0, "B900W", 3,0x110a, 26,26,   0)
drvBkhAsynConfig(4, "A2114", 5,     0,  8, 8,   0)
drvBkhAsynConfig(4, "A2124", 5,     8,  8, 8,   0)

#asynSetTraceIOMask( "A2114",0,4)
#asynSetTraceMask( "A2114",0,0x9)

dbLoadRecords( "db/bkh$(N).db","P=$(P),M=$(N),IOC=$(IOC),LOC=$(LOC)")
